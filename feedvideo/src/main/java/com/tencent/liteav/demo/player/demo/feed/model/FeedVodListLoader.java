...
public class FeedVodListLoader {
    ...
    private List<VideoModel> loadDefaultVodList() {
        ...
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_achievements_introduction);;
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_achievements_detail);
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774544650";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_steady_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_steady_detail);
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774644824";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_real_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_real_detail);
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774211080";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_complete_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_complete_detail);
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774545556";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_business_introduction_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_business_introduction_detail);
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774574470";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.what_are_numbers_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.what_are_numbers_detail);
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774253670";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.simplify_complexity_and_build_big_from_small_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.simplify_complexity_and_build_big_from_small_detail);;
        list.add(model);
        model = new VideoModel();
        model.appid = 1500005830;
        model.fileid = "387702299774390972";
        model.playAction = PLAY_ACTION_PRELOAD;
        model.videoDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_introduction);
        model.videoMoreDescription = mContext.getString(com.tencent.liteav.demo.vodcommon.R.string.tencent_cloud_audio_and_video_detail);
        list.add(model);
        return list;
    }
    /**
